...
**2. Its content has a generation marker** in the first 10 lines (case-insensitive substring): `@generated`, `DO NOT EDIT`, `automatically generated`, `Code generated by`, `@autogenerated`, `@codegen`, `@nocheck`.

**3. It matches a pattern in `.coding-standards-ignore`** at the project root (gitignore-style):
